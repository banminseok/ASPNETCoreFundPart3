<%@ Page Title="전화 번호 확인" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="VerifyPhoneNumber.aspx.vb" Inherits="IdeaApp.WebForms.VerifyPhoneNumber" %>
